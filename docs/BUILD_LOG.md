# HTTP/2 From Scratch — Build Log

The chronological working notes / build history for this stack: every feature,
the design decisions behind it, the edge cases found along the way, and how each
was verified. Extracted from `CLAUDE.md` (2026-07-20) to keep the
agent-instructions file lean. For the architecture, conventions, and a
