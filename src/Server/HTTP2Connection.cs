...
// HTTP2Settings (connection settings) and the HTTP2RequestHandler delegate live
// in the shared library (HTTP2Settings.cs / HTTP2RequestHandler.cs) — both are
// direction-neutral and are referenced by the client and HTTPSemantics too.
